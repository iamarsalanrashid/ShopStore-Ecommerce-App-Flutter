...
class _AuthCardState extends State<AuthCard>
  ...
  _showErrorDialogue(String message) {
    showDialog(
        context: context,
  ...
  Future<void> _submit(BuildContext ctx) async {
    ...
    try {
      if (_authMode == AuthMode.Login) {
        // Log user in
        await Provider.of<Auth>(ctx, listen: false).login(
          _authData['email'] as String,
          _authData['password'] as String,
        );
      } else {
        // Sign user up
        await Provider.of<Auth>(ctx, listen: false).signup(
          _authData['email'] as String,
          _authData['password'] as String,
        );
      }
    } on HttpException catch (error) {
      //special catch block to handle only validation related errors
